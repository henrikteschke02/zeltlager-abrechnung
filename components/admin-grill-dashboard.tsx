      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-[#4c503d]/70 dark:text-muted-foreground text-sm mt-1">Verwalte die verfügbaren Fleischsorten für das Lager.</p>
          </div>
          <Button 
          ...
          {loadingItems ? (
            <div className="text-center p-8 bg-white/5 backdrop-blur-sm border border-black/10 dark:border-white/10 rounded-2xl flex justify-center items-center">
             ...
             <div className="text-center p-8 bg-white/5 backdrop-blur-sm border border-black/10 dark:border-white/10 rounded-2xl">
               <p className="text-[#4c503d]/70 dark:text-muted-foreground">Kein Fleisch angelegt. Füge ein neues Produkt hinzu!</p>
             </div>
          ) : (
            items.map((item) => (
